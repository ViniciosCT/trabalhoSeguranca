...
<input form="cadastro" type="text" id="nome" name="nome" value="<c:out value='${funcionario.nome}'/>" required>
<br>
<label form="cadastro" for="login">Login</label>
<input form="cadastro" type="text" id="login" name="login" value="<c:out value='${funcionario.login}'/>" required>
<br>
<label form="cadastro" for="senha">Senha</label>
<input form="cadastro" type="password" id="senha" name="senhaStr" required>
<br>
<p> Escolha um veíulo:  Veículo atual: <c:out value="${funcionario.veiculo.placa}"/></p>
